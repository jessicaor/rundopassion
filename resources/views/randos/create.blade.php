            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control {{$errors->has('date')?'is-invalid': ''}}" name ="date" id="InputTitle" placeholder="Title" value="">
                    </div>     
                    <div class="form-group">
                        <label for="InputName">Heure</label>
                        <input type="text" class="form-control {{$errors->has('heure')?'is-invalid': ''}}" name ="heure" id="InputTitle" placeholder="Title" value="">
                    </div>               
                    <div class="form-group">
                        <label for="InputName">Distance</label>
                        <input type="text" class="form-control {{$errors->has('distance')?'is-invalid': ''}}" name ="distance" id="InputTitle" placeholder="Title" value="">
                    </div>               
